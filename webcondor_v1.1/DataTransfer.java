/**
 * This class generates data,then submits DAG.
 */
package webcondor;
...
public class DataTransfer implements Runnable{
	 ...
	 * @param source
	 * @param destination
	 * @param size Size of one file.
	 * @param number Number of files.
	 * @param repeat How many times the job will be repeated.
	 * @param parallel
	 * @param protocol http or ftp.
	 * @param putorget put or get.
	 * @param v4orv6 ipv4 or ipv6.
...
//		String line = null;
		...
		try {
			...
			DagSubmit ds = new DagSubmit(id,webservice_url,user,source_machine,destination_machine,source_DataDirectory,des_DataDirectory,starttime,
					stoptime,repeat,arguments,requirements,ddclusterID,FtpPutRm,usertime);
			ds.submit();
